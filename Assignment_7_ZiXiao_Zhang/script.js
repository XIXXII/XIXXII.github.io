...
console.log(`John's BMI is ${secondJohnBMIversion - secondLucasBMIversion} than Lucas's.`)
console.log("----------------------------------------");
// Data 1 Test
...
console.log(`Lucas weights is ${firstLucasWeights}kg and is ${firstLucasHeight}m tall. His BMI is ${firstLucasBMIversion1.toFixed(1)}.`);
console.log(`John weights is ${firstJohnWeights}kg and is ${firstJohnHeight}m tall. His BMI is ${firstJohnBMIversion1.toFixed(1)}.`);
